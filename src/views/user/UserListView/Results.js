...
const tableHeaders = [
  { key: 'username', name: 'Username', sort: true },
  { key: 'email', name: 'Email', sort: true },
  { key: 'role_name', name: 'Role', sort: true },
  { key: 'fullname', name: 'Full Name', sort: true },
            ...
            <TableBody>
              {user.map((usr) => (
                ...
                >
                  ...
                  <TableCell>
                    {moment(usr.created_at).format('DD/MM/YYYY HH:mm:ss')}
                  </TableCell>
                  <TableCell>
                    <IconButton
